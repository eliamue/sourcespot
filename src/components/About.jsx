      ...
      <div className="about-container">
        <div className="suggestion-container">
          ...
          <section className="about-me">
            <p>
              I am a full-stack software engineer from St Paul, Minnesota with a background in psychology, CCBHC mental health, and board game publishing. My goal is to combine this background with software development in order to work with a team on creating and maintaining inclusive apps that accommodate the needs of marginalized communities. Always preferring to keep busy, I fill my non-coding time with as much dance, D&D, studying French & Korean, crafting, and board games as I can get!
            </p>
            <p>
